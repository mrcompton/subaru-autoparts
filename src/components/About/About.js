        ...
        return (
            <div className='about'>
                <div className='about-items'>
                    ...
                    <p>Sed nec orci rutrum velit aliquam sagittis non id velit. Etiam et lobortis urna, quis tristique dui. Pellentesque commodo mollis ante, id varius urna aliquet vel. Nunc ut fermentum magna. Proin nec pretium erat. Suspendisse suscipit lacus bibendum metus pulvinar, ut lacinia nisl eleifend.</p>
                </div>
            </div>
        )
    }
